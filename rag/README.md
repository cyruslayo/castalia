...
21. Multi-modal Retrieval 📽️
    ...
    - **Castalia follow-on track**: for a full curriculum that expands these ideas into image, document, audio, and video systems, continue with [multimodal/](../multimodal/).
